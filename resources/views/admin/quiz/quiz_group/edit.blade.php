<x-admin-layout title="Update Quiz Group">
    @section('styles')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            @endif
            <form id="quizGroupForm" action="{{ url('admin/update-quiz-group/'.$quizGroupData['slug'].'/'.$quizGroupData['id']) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" value="{{ $quizGroupData['title'] }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="quiz_group_order">Order</label>
                                            <input type="number" class="form-control" min="1" id="quiz_group_order" name="quiz_group_order" value="{{ $quizGroupData['quiz_group_order'] }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="color">Select Group Display color:</label>
                                            <input type="color" id="color" name="color" value="{{ $quizGroupData['color'] }}">
                                        </div>
                                    </div>
                                    {{-- <div class="col-lg-6">
                                        <div class="form-group">
